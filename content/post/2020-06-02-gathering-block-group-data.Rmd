...
* AApop = # of African Americans in block group
* txHispop = # of Hispanics in block group
* txwpop = # of non-Hispanic whites in block group
* txtotpop = # of total population in block group
* txmedinc = median family income of block group
